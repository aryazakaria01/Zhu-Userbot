...
REPOLINK = (
    ...
    else "https://github.com/Kenzuuu/Love-Userbot"
)
# ============================================
...
async def killdabot(event):
    ...
    await event.edit("**Mematikan Love-Userbot....**")
...
async def reedme(e):
    await e.edit(
        ...
        "\n[💘 Love-UserBot Repo](https://github.com/Kenzuuu/Kenzhu/blob/Love-UserBot/README.md)"
